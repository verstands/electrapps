...
<html lang="en">
    <head>
        ...
        <link href="<?php echo e(asset('css_user/css/styles.css')); ?>" rel="stylesheet" />
        <link href="<?php echo e(asset('css_user/css/fontawesome.css')); ?>" rel="stylesheet" />
    ...
    <?php echo $__env->yieldContent('content'); ?>
        ...
        <!-- Core theme JS-->
        <script src="<?php echo e(asset('css_user/js/scripts.js')); ?>"></script>
        <!-- * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * * *-->
        <!-- * *                               SB Forms JS                               * *-->
...
<?php /**PATH /home/u333122526/domains/frobill.cloud/public_html/pay/resources/views/layout/user.blade.php ENDPATH**/ ?>