...
<head>
  ...
  <link rel="icon" type="image/x-icon" href="https://electrapps.com/css_pay/assets/img/error.png">
      ...
      <div class="page-banner home-banner">
        <div class="row align-items-center flex-wrap-reverse h-100">
          <div class="col-md-6 py-5 wow fadeInLeft">
            ...
            <p class="text-lg text-grey mb-5">Une erreur s'est produite lors du traitement. Veuillez réessayer.</p>
          ...
          <div class="col-md-6 py-5 wow zoomIn">
            <div class="img-fluid text-center">
              <img src="https://electrapps.com/css_pay/assets/img/error.png" height="150" width="150" alt="">
            </div>
          </div>
        </div>
      </div>
...
<?php echo $__env->make('layout.user', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u333122526/domains/frobill.cloud/public_html/pay/resources/views/user/erreur.blade.php ENDPATH**/ ?>