          ...
          <div class="col-md-6">
           ...
           <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
              ...
              <form  id="contactForm" action="https://cardpayment.flexpay.cd/v1/pay" method="post">
                ...
                <input type="hidden" name="description" value="<?php echo e($affichages->id_comp); ?>-CARD-<?php echo e($ref); ?>"/>
                  
                <input type="text" class="form-control" name="phone" value="<?php echo e($user); ?>" placeholder="Telephone">
                <h5><center>Selectionnez ou inserez le montant que vous aimeriez offrir</center></h5>         
                    ...
                    <br>
                    <div></div>
                <input type="text" class="form-control" id="inputs" value="<?php echo e($amount); ?>" name="amount" placeholder="Montant"><br>
                <input type="hidden" class="form-control" value="<?php echo e($affichages->id_comp); ?>-CARD-<?php echo e($ref); ?>" name="reference" placeholder="Montant">
...
<?php echo $__env->make('layout.travail', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u333122526/domains/frobill.cloud/public_html/pay/resources/views/user/user8.blade.php ENDPATH**/ ?>