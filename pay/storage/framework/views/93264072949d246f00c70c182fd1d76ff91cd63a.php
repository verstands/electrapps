      ...
      <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
        ...
        <?php $__currentLoopData = $approuve; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $affiches): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>:
          <tr>
            ...
            <?php if($affiches->statut == 0): ?>
                <td><p style="color:red;">Non approuver</p></td>
            <?php elseif($affiches->statut == 1): ?>
...
<?php echo $__env->make('layout.body', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u333122526/domains/frobill.cloud/public_html/pay/resources/views/pages/affiche_approuve.blade.php ENDPATH**/ ?>